...
public class BlackJackManager : MonoBehaviour
{
    ...
    public int studyPoint { get; private set; }
    ...
    {
        //----------------------------------------------------------------------------------------------------
        //초기화 전 여기서 데이터 매니저에게 학습 포인트를 넘겨주면 될 것 같습니다.
        //
        //업데이트 되야하는 데이터
        //  "습득한 학습 포인트 : blackJackManager(this)의 "studyPoint"변수에 있음.
        //----------------------------------------------------------------------------------------------------
    ...
    public bool IsGameOver()
    {
        ...
        return (cardManager.ca <= 0 || cardManager.GetDeckNum() <= 0);
    }
    ...
    public void ToggleActiveCards(bool toggle)
    {
        cardManager.HideCards(toggle);
    }
